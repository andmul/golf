...
def build_figure(df: pd.DataFrame) -> go.Figure:
    ...
    # Determine X-axis range for "always last 15 bars" logic
    total_bars = len(df)
    window_size = 15
    range_end = total_bars - 0.5
    range_start = max(-0.5, range_end - window_size)
